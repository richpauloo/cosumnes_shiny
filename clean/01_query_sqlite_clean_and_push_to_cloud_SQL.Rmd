...
```{r}
# most current data
present <- dbReadTable(cdb, "present2")
...
dbWriteTable(cdb, "present2", complete, overwrite = TRUE) # overwrite existing table
```
...
If the battery life for any LS or LL is below 
