...
* add coordinates for wells from Andrew's Slack message  
* integrate datastream with online app  
* write list of emails to send report to  
* write batch file to run `03_run.R` every 24 hours  
...
`clean/dependencies/ll_battery_outages.csv`  
